          ...
          >
              ...
              <div className="flex flex-col gap-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    step="0.01"
                    required
                    className="w-full border border-gray-200 rounded-xl pl-8 pr-4 py-3 text-sm text-gray-800 placeholder-gray-350 outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-400/15 transition-all duration-150"
                  />
                </div>
              </div>
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <button
                  ...
                  className="w-full flex items-center justify-between border border-gray-200 rounded-xl px-4 py-3 text-sm bg-white hover:border-amber-300 outline-none transition-all duration-150"
                >
                  <span className={selectedCategory ? "text-gray-800 font-medium" : "text-gray-350"}>
                    {selectedCategory
            ...
            <div className="flex flex-col gap-2">
              ...
              <textarea
                ...
                rows={3}
                className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-800 placeholder-gray-350 outline-none focus:border-amber-400 focus:ring-2 focus:ring-amber-400/15 transition-all duration-150 resize-none"
              />
            </div>
